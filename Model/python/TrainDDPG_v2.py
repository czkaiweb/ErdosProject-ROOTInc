...
class Trainer:
    ...
    def save_models(self, episode_count):
        ...
        :return:
        """
        torch.save(self.target_actor.state_dict(), './model/' + str(episode_count) + '_actor.pt')
        torch.save(self.target_critic.state_dict(), './model/' + str(episode_count) + '_critic.pt')
    ...
    def load_models(self, episode):
        ...
        :return:
        """
        self.actor.load_state_dict(torch.load('./model/' + str(episode) + '_actor.pt'))
        self.critic.load_state_dict(torch.load('./model/' + str(episode) + '_critic.pt'))
        UtilsDDPG.hard_update(self.target_actor, self.actor)
        UtilsDDPG.hard_update(self.target_critic, self.critic)
